...
To get started, first clone this repo & run `npm install --g lerna`. Next, you'll need to run `lerna boostrap` to initialize the dependencies of all packages (server & frontend).
